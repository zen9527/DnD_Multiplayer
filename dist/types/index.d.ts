...
export type MessageType = 'CREATE_GAME' | 'JOIN_GAME' | 'CHAT_MESSAGE' | 'DICE_ROLL' | 'NPC_CREATE' | 'EVENT_CREATE' | 'GAME_CREATED' | 'GAME_STATE' | 'PLAYER_JOINED' | 'PLAYER_LEFT' | 'CHAT_MESSAGE' | 'DICE_ROLL_RESULT' | 'NPC_CREATED' | 'EVENT_CREATED' | 'ERROR';
